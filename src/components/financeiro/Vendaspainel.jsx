...
import { ShoppingCart, Today, EventAvailable, SwitchAccount, ForwardToInbox, MonetizationOn, ToggleOn, ToggleOff,Visibility, VisibilityOff, AccountBalance, Delete, Edit, Add, People } from "@mui/icons-material";
...
import Deletevenda from './Deletevenda';
...
function Vendaspainel(props) {
    ...
    const handleChangeRowsPerPage = (event) => {
     ...
     const handleSearch = (search) => {
      ...
      let new_list = vendas.filter(venda=> venda.name);
      //setFuncionarios()
    ...
    const getComponent = () =>{
      switch(opcao){
        case 'ADD': 
              return <Formvenda  sel={venda} opcao={opcao} setOpenModel={setOpenModel} primery={primery} secudary={secudary} empresa={empresa}  />; 
        case 'EDITAR':           
              return <Formvenda  sel={venda} opcao={opcao} setOpenModel={setOpenModel} primery={primery} secudary={secudary} empresa={empresa}  />; 
        case 'DELETE':
              return <Deletevenda negocio={venda}  primery={primery} secudary={secudary}/>;
       	case 'CLOSE':
