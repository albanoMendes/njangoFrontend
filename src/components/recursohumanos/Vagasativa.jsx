...
export default function Vagasativa(props) {
  ...
  return (
    <>
      <Box sx={{ width: '100%' }}>
        ...
        >
        	<Formvagas primery={primery} secudary={secudary} emprego={vaga} opcao='EDITAR' setOpenModel={setOpenModel} />
      	</Model>      
    </>
