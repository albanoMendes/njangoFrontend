...
function createData(id, title, subtitle, tipo, autor, data, conteudo1, conteudo2, conteudo3, image1, image2, more) {
  return {
    id,
    title,
    subtitle,
  ...
  return (
    <>
      ...
      <Model
        ...
        >
         <Read primery={primery} secudary={secudary} blog={blog}/>
      </Model>      
    </>
