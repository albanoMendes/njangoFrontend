...
function Deletepartener({partener, setOpenModel, iduser, primery, secudary}){
    ...
    <>
       <DialogContent>
          <DialogContentText id="alert-dialog-description">
            {`Tem certeza que deseja Apagar o participante: ${partener.name} ?`}
          </DialogContentText>
        </DialogContent>
        <DialogActions>         
        <Button
