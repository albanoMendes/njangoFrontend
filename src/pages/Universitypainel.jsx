...
import Homepainel from '../components/university/Homepainel';
import Artigospainel from '../components/university/Artigospainel';
import Membrospainel from '../components/university/Membrospainel';
import Paymentpainel from '../components/university/Paymentpainel';
...
function Universitypainel(props) {
	...
	const [empresa, setEmpresa] = useState({
		id: '9fe1g44ru32',
		name: 'Universidade Piajet Angola',
		departamento: 'D. Ciências Economicas',
		Orietador: 'Dr. Paulo Agusto Ndembo',
		phone: '+244 926 342 232',
		email: 'economia.peajet@gmail.com',
		logo: 'logo_piajet.png', 
	})
	        ...
	        >
	            ...
	            >
	                ...
	                <TabPanel value={value} index={1}>
	                     <Artigospainel primery={primery} secudary={secudary} logado={logado} setLogado={setLogado} user={user} setUser={setUser} status={status} setStatus={setStatus} empresa={empresa} />
	                </TabPanel>           
	              	<TabPanel value={value} index={2}>
	                	<Membrospainel primery={primery} secudary={secudary} logado={logado} setLogado={setLogado} user={user} setUser={setUser} status={status} setStatus={setStatus} empresa={empresa} />
	            	</TabPanel>
	             	<TabPanel value={value} index={3}>
	                	<Paymentpainel primery={primery} secudary={secudary} />
	              </TabPanel>       
	            </Box>
	        </Stack>
	      </div>
...
export default Universitypainel;