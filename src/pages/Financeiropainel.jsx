...
import Homepainel from '../components/financeiro/Homepainel';
...
function Financeiropainel(props) {
	            ...
	            >
	                <TabPanel value={value} index={0}>
	              	...
	              	<TabPanel value={value} index={1}>
	                	<Paymentdiarios primery={primery} secudary={secudary} empresa={empresa} />
	            	</TabPanel>
	             	<TabPanel value={value} index={2}>
	                	<Caixapainel primery={primery} secudary={secudary} />
	              </TabPanel>       
	            </Box>
	        </Stack>
	      </div>
