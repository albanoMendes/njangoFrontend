...
import Homepainel from '../components/investidor/Homepainel';
import Myinvestments from '../components/investidor/Myinvestments';
...
function Investidorpainel(props) {
	            ...
	            >
	                <TabPanel value={value} index={0}>
	              	...
	              	<TabPanel value={value} index={1}>
	                	<Myinvestments primery={primery} secudary={secudary} logado={logado} setLogado={setLogado} user={user} setUser={setUser} status={status} setStatus={setStatus} />
	            	</TabPanel>
...
export default Investidorpainel;